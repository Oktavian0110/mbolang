...
<body>
  ...
  <div class="container-fluid">
    <br>
    <center><h1><b>Cerita Wisataku</b></h1></center><br>
    <a href="cerita_tambah.php" class="btn btn-outline-dark">Sharing Cerita</a>
    <br><br>
    <?php
    include 'koneksi.php';
    extract($_GET);
    $query = "SELECT u.nama, w.nama, c.cerita, c.foto FROM tbcerita AS c INNER JOIN tbuser AS u ON c.id_user=u.id_user 
                INNER JOIN tbwisata AS w ON c.id_wisata=w.id_wisata";
    ...
    <p><?php echo $r_tampil_anggota['cerita']; ?></p>
    <hr>
    <?php
      }
    }
